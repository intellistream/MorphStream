package application.topology.faulttolerance;

import application.bolts.comm.GeneralParserBolt_FT;
import application.bolts.wc.SplitSentenceBolt_FT;
import application.bolts.wc.WordCountBolt_FT;
...
import static application.constants.WordCount_FTConstants.PREFIX;
