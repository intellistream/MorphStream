 ...
 */
public class SHJBolt_Locks extends SHJBolt {
    private static final Logger LOG = LoggerFactory.getLogger(SHJBolt_Locks.class);
    private static final long serialVersionUID = -5968750340131744744L;

    public SHJBolt_Locks(int fid, SINKCombo sink) {
        super(LOG, fid, sink);
    }
