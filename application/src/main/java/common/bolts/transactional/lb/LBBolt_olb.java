...
public class LBBolt_olb extends LBBolt_LA {
    private static final Logger LOG = LoggerFactory.getLogger(LBBolt_olb.class);
    private static final long serialVersionUID = -5968750340131744744L;

    public LBBolt_olb(int fid, SINKCombo sink) {
        super(LOG, fid, sink);

    }

    public LBBolt_olb(int fid) {
        super(LOG, fid, null);
