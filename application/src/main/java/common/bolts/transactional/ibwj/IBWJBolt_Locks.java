 ...
 */
public class IBWJBolt_Locks extends IBWJBolt {
    private static final Logger LOG = LoggerFactory.getLogger(IBWJBolt_Locks.class);
    private static final long serialVersionUID = -5968750340131744744L;

    public IBWJBolt_Locks(int fid, SINKCombo sink) {
        super(LOG, fid, sink);
    }
