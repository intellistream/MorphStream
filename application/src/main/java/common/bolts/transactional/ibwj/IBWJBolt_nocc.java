 ...
 */
public class IBWJBolt_nocc extends IBWJBolt_Locks {
    private static final Logger LOG = LoggerFactory.getLogger(IBWJBolt_nocc.class);
    private static final long serialVersionUID = -5968750340131744744L;

    public IBWJBolt_nocc(int fid, SINKCombo sink) {
        super(fid, sink);
    }

    //constructor without compose everything together.
    public IBWJBolt_nocc(int fid) {
        super(fid, null);
    }
