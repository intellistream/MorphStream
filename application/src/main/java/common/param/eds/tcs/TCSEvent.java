...
public class TCSEvent extends TxnEvent {
    ...
    public TCSEvent(double bid, int pid, String bid_array, String partition_index, int number_of_partitions,
    ...
    public TCSEvent cloneEvent() {
        return new TCSEvent(bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions,
                wordID, tweetID);
    }
}
