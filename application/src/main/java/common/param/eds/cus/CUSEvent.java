...
public class CUSEvent extends TxnEvent {
    ...
    public CUSEvent(double bid, int pid, String bid_array, String partition_index, int number_of_partitions,
    ...
    public CUSEvent cloneEvent() {
        return new CUSEvent(bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions,
                tweetID, clusterID);
    }
}
