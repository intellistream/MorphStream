...
public class WUSEvent extends TxnEvent {
    ...
    public WUSEvent(double bid, int pid, String bid_array, String partition_index, int number_of_partitions, String word, String wordID, String tweetID) {
    ...
    public WUSEvent cloneEvent() {
        return new WUSEvent(bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions, word, wordID, tweetID);
    }
}
