...
public class SCSEvent extends TxnEvent {
    ...
    public SCSEvent(double bid, int pid, String bid_array, String partition_index, int number_of_partitions,
    ...
    public SCSEvent cloneEvent() {
        return new SCSEvent(bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions,
                tweetID, isBurst);
    }
}
