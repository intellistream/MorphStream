...
public class ESSEvent extends TxnEvent {
    ...
    public ESSEvent(double bid, int pid, String bid_array, String partition_index, int number_of_partitions, String clusterID) {
    ...
    public ESSEvent cloneEvent() {
        return new ESSEvent(bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions, clusterID);
    }
}
