...
public class NonMicroEvent extends TxnEvent {
    ...
    public NonMicroEvent(double bid, int pid, String bid_array, String partition_index, int num_of_partition, String key_array, int TOTAL_NUM_ACCESS, int Transaction_Length, boolean isAbort, boolean isNon_Deterministic_StateAccess) {
