 ...
 */
public class LBTPGDataGeneratorConfig extends DataGeneratorConfig {
    private static final Logger LOG = LoggerFactory.getLogger(LBTPGDataGeneratorConfig.class);
