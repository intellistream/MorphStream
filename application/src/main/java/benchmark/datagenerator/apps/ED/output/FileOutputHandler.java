package benchmark.datagenerator.apps.ED.output;
...
public class FileOutputHandler implements IOutputHandler {
    protected static final Logger log = LoggerFactory.getLogger(benchmark.datagenerator.apps.ED.output.FileOutputHandler.class);
