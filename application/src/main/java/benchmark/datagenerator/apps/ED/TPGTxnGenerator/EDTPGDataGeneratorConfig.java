...
public class EDTPGDataGeneratorConfig extends DataGeneratorConfig {
    private static final Logger LOG = LoggerFactory.getLogger(EDTPGDataGeneratorConfig.class);
