 ...
 */
public class IBWJTPGDataGeneratorConfig extends DataGeneratorConfig {
    private static final Logger LOG = LoggerFactory.getLogger(IBWJTPGDataGeneratorConfig.class);
