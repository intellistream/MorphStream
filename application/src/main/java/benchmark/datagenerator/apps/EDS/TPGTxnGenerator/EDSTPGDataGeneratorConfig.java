...
//TODO: Copied from GSW DataGenerator Config, change accordingly
public class EDSTPGDataGeneratorConfig extends DataGeneratorConfig {
    private static final Logger LOG = LoggerFactory.getLogger(EDSTPGDataGeneratorConfig.class);
