...
public class VShapedDAG extends Client {
    ...
    @Override
    public Result postUDF(long bid, String dagName, HashMap<String, Function> FunctionMap) {
        return new Result(bid);
    }

    @Override
    public void defineFunction() {
        FunctionDAGDescription VShapedDAG = new FunctionDAGDescription("VShapedDAG");
        ...
        VShapedDAG.addFunctionDescription("function_2", function_2);
        VShapedDAG.addFunctionDescription("function_3", function_3);
        this.txnDescriptions.put("VShapedDAG", VShapedDAG);
    }
}
