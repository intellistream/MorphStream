package intellistream.morphstream.examples.utils.datagen.apps.NonGS.TPGTxnGenerator.Transaction;

import intellistream.morphstream.examples.utils.datagen.InputEvent;

public class NonGSInputEvent extends InputEvent {
    private final int id;
    private final int[] keys;
    private final boolean isAbort;
    private final boolean isNon_Deterministic_StateAccess;

    public NonGSInputEvent(int id, int[] keys, boolean isAbort, boolean isNonDeterministicStateAccess) {
        this.id = id;
        this.keys = keys;
