...
public abstract class Sinkhelper {
    private static final Logger LOG = LoggerFactory.getLogger(Sinkhelper.class);
    ...
    public Sinkhelper(int runtime, double predict, int size, String metric_path, int thisTaskId) {
