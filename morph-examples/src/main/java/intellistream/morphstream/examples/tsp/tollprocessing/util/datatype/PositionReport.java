 ...
 * #_
 */
package intellistream.morphstream.examples.tsp.tollprocessing.util.datatype;

import intellistream.morphstream.examples.tsp.tollprocessing.util.datatype.util.Constants;
import intellistream.morphstream.examples.tsp.tollprocessing.util.datatype.util.IPositionIdentifier;
import intellistream.morphstream.examples.tsp.tollprocessing.util.datatype.util.ISegmentIdentifier;
...
public final class PositionReport extends AbstractInputTuple implements IPositionIdentifier, ISegmentIdentifier {
    ...
    public PositionReport(Short time, Integer vid, Integer speed, Integer xway, Short lane, Short direction,
                          Integer segment, Integer position) {
