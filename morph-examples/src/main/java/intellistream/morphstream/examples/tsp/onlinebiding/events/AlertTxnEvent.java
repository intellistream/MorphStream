...
public class AlertTxnEvent extends TxnEvent {
    ...
    public AlertTxnEvent(int bid, String bid_array, int partition_id, int number_of_partitions,
    ...
    @Override
    public AlertTxnEvent cloneEvent() {
        return new AlertTxnEvent((int) bid, Arrays.toString(bid_array), pid, number_of_partitions, num_access, Arrays.toString(itemId), Arrays.toString(ask_price));
    }
}
