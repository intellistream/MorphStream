...
public class GSWTxnEvent extends TxnEvent {
     ...
     * @param numAccess
     */
    public GSWTxnEvent(int[] keys, boolean flag, int numAccess, long bid
     ...
     * @param key_array
     */
    public GSWTxnEvent(int bid, int pid, String bid_array, int num_of_partition,
    ...
    public GSWTxnEvent(int bid, int pid, String bid_array, String partition_index, int num_of_partition,
    ...
    public GSWTxnEvent cloneEvent() {
        return new GSWTxnEvent((int) bid, pid,
