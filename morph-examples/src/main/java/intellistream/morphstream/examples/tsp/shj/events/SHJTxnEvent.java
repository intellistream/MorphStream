 ...
 */
public class SHJTxnEvent extends TxnEvent {
    ...
    public SHJTxnEvent(long bid, int pid, String bid_array, String partition_index, int number_of_partitions,
    ...
    public SHJTxnEvent cloneEvent() {
        return new SHJTxnEvent(bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions, key, streamID, amount, lookupKeys);
    }
}