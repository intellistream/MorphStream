 ...
 */
public class GSEvent extends TxnEvent {
     ...
     * @param numAccess
     */
    public GSEvent(int[] keys, boolean flag, int numAccess, long bid
     ...
     * @param key_array
     */
    public GSEvent(int bid, int pid, String bid_array, int num_of_partition,
    ...
    public GSEvent(int bid, int pid, String bid_array, String partition_index, int num_of_partition,
...
//        return String.format("%-" + length + "." + length + "s", text);
    ...
    public GSEvent cloneEvent() {
        return new GSEvent((int) bid, pid,
