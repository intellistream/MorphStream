...
public class DepositTxnEvent extends TxnEvent {
     ...
     */
    public DepositTxnEvent(int bid, int pid, String bid_array, String partition_index, int num_of_partition,
                           String accountId,
                           String bookEntryId,
    ...
    public DepositTxnEvent cloneEvent() {
        return new DepositTxnEvent((int) bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions, accountId, bookEntryId, accountTransfer, bookEntryTransfer);
    }
}
