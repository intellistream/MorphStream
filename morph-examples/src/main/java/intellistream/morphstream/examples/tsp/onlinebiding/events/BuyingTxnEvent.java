...
public class BuyingTxnEvent extends TxnEvent {
    //expected state.
    //long Item_value=0;
    //long asset_value=0;
     ...
     */
    public BuyingTxnEvent(int[] itemId, int partition_id, long[] bid_array, long bid, int number_of_partitions) {
     ...
     * Creates a new BuyingEvent.
     */
    public BuyingTxnEvent(int[] itemId, int partition_id, String bid_array, long bid, int number_of_partitions, String partition_index, boolean isAbort) {
     ...
     */
    public BuyingTxnEvent(int bid, String bid_array, int pid, int num_of_partition,
    ...
    @Override
    public BuyingTxnEvent cloneEvent() {
        return new BuyingTxnEvent((int) bid, Arrays.toString(bid_array), pid, number_of_partitions, Arrays.toString(itemId), Arrays.toString(bid_price), Arrays.toString(bid_qty));
    }
}
