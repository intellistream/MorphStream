...
public interface WordCount_FTConstants extends BaseConstants {
    String PREFIX = "wc_ft";
    int max_hz = 450000;
    ...
    interface Conf extends BaseConf {
        String SPLITTER_THREADS = "wc_ft.splitter.threads";
        String COUNTER_THREADS = "wc_ft.counter.threads";
    }
