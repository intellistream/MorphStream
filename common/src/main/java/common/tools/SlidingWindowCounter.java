 ...
 * counts of objects, and 2) to give a partition "consumer" thread (e.g. {@link PeriodicSlidingWindowCounter}) read access
 ...
 * <p/>
 * To give an streaming, using a counter with 5 slots which for the sake of this streaming represent 1 minute of time each:
 * <p/>
 * <pre>
 * {@code
 ...
 * </pre>
 * <p/>
 * As you can see in this streaming, for the first <code>windowLengthInSlots</code> (here: the first five minutes) the
 ...
 * counts.
 * <p/>
 * On a high-level, the counter exhibits the following behavior: If you asked the streaming counter after two minutes,
