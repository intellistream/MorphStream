...
public class StreamMonitorThread implements Runnable {
    private static final Logger LOG = LoggerFactory.getLogger(StreamMonitorThread.class);
    ...
    //TODO: A potential optimization Monitor Thread, which performs pattern detection aggregatively instead of per-batch

    public StreamMonitorThread(BlockingQueue<PatternData> patternDataQueue) {
        StreamMonitorThread.patternDataQueue = patternDataQueue;
    }
