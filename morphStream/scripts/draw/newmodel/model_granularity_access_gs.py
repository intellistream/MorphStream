...
def getPathGS(algo, inputEvents, tthread, NUM_ITEMS, Ratio_of_Multiple_State_Access, key_skeiwness, overlap_ratio, abort_ratio, txn_length, isCyclic, complexity):
