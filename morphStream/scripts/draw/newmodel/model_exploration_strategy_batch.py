...
def ReadFileGS(x_axis, tthread, batchInterval, NUM_ITEMS, Ratio_of_Multiple_State_Access, key_skewness, overlap_ratio, abort_ratio, txn_length, isCyclic, complexity):
    ...
    for batchInterval in x_axis:
        ...
        op_gs_path = getPathGS("OP_NS", inputEvents, tthread, NUM_ITEMS, Ratio_of_Multiple_State_Access, key_skewness, overlap_ratio, abort_ratio, txn_length, isCyclic, complexity)
    ...
    for batchInterval in x_axis:
        inputEvents = tthread * batchInterval
        op_dfs_path = getPathGS("OP_BFS", inputEvents, tthread, NUM_ITEMS, Ratio_of_Multiple_State_Access, key_skewness, overlap_ratio, abort_ratio, txn_length, isCyclic, complexity)
    ...
    for batchInterval in x_axis:
        inputEvents = tthread * batchInterval
        op_dfs_path = getPathGS("OP_DFS", inputEvents, tthread, NUM_ITEMS, Ratio_of_Multiple_State_Access, key_skewness, overlap_ratio, abort_ratio, txn_length, isCyclic, complexity)
        lines = open(op_dfs_path).readlines()
        throughput = lines[0].split(": ")[1]
...
if __name__ == '__main__':
    ...
    legend = True
    y_axis = ReadFileGS(x_axis, tthread, batchInterval, NUM_ITEMS, Ratio_of_Multiple_State_Access, key_skewness, overlap_ratio, abort_ratio, txn_length, isCyclic, complexity)
    DrawFigure(x_values, y_axis, legend_labels, "Punctuation Interval", "Throughput (K/sec)", 0, 400, "gs_exploration_strategy_batch_t{}_b{}_{}_{}_{}_{}_{}_{}_{}"
                .format(tthread, NUM_ITEMS, batchInterval, Ratio_of_Multiple_State_Access, key_skewness, overlap_ratio, abort_ratio, txn_length, isCyclic, complexity),
                legend)
