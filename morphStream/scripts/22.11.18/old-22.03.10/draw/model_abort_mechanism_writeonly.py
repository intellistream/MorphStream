...
def ReadFileSL(x_axis, tthread, batchInterval, NUM_ITEMS, deposit_ratio, key_skewness, overlap_ratio, abort_ratio,
               isCyclic, complexity):
    w, h = 2, len(x_axis)
    y = [[] for _ in range(w)]
    ...
    for deposit_ratio in x_axis:
        ...
        op_gs_path = getPathSL("OPGSA", inputEvents, tthread, NUM_ITEMS, deposit_ratio, key_skewness, overlap_ratio,
    ...
    for deposit_ratio in x_axis:
        inputEvents = tthread * batchInterval
        op_gs_path = getPathSL("OPGS", inputEvents, tthread, NUM_ITEMS, deposit_ratio, key_skewness, overlap_ratio, abort_ratio,
                               isCyclic, complexity)
        lines = open(op_gs_path).readlines()
        throughput = lines[0].split(": ")[1]
...
if __name__ == '__main__':
    ...
    y_axis = ReadFileSL(x_values, tthread, batchInterval, NUM_ITEMS, deposit_ratio, key_skewness, overlap_ratio,
                          abort_ratio, isCyclic, complexity)
    DrawFigure(x_values, y_axis, legend_labels, "writeonly_ratio", "throughput(e/s)", 0 ,400,
               'sl_abort_mechanism_comparison_writeonly_t{}_b{}_{}_{}_{}_{}_{}_{}_{}'
