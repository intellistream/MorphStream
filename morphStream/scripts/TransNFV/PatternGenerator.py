...
class PatternGenerator:
    def __init__(self, tuple_range=10000, instance_count=4, request_count=1000, pattern_1_prob=0.8, pattern_2_prob=1, pattern_3_prob=0.8):
        self.tuple_range = tuple_range
        self.instance_count = instance_count
        self.request_count = request_count
        self.base_dir = os.path.join(os.getcwd(), 'scripts/TransNFV/pattern_files')
    ...
    def generate_files(self):
        ...
        for pattern_name, generation_method in patterns.items():
            pattern_dir = os.path.join(self.base_dir, pattern_name)
