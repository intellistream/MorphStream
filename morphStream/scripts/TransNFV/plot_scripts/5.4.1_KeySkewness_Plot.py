...
plt.savefig(os.path.join(figure_dir, '5.4.1_Key_Skewness_Throughput.pdf'))  # Save the figure
plt.savefig(os.path.join(figure_dir, '5.4.1_Key_Skewness_Throughput.png'))  # Save the figure
...
plt.savefig(os.path.join(local_figure_dir, '5.4.1_Key_Skewness_Throughput.pdf'))  # Save the figure