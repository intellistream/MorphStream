...
throughput_data = np.array([
    [237300, 233328],  # Throughput for key skewness 0.1
    [235906, 235347],  # Throughput for key skewness 0.25
    [236459, 236613],  # Throughput for key skewness 0.5
    [238049, 201673],  # Throughput for key skewness 0.75
    [238041, 235560]   # Throughput for key skewness 1
])
...
plt.savefig(os.path.join(figure_dir, '5.4.2_Key_Skewness_Throughput.pdf'))  # Save the figure
plt.savefig(os.path.join(figure_dir, '5.4.2_Key_Skewness_Throughput.png'))  # Save the figure
...
plt.savefig(os.path.join(local_figure_dir, '5.4.2_Key_Skewness_Throughput.pdf'))  # Save the figure