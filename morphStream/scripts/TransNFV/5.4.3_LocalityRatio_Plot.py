...
throughput_data = np.array([
    [45454, 843570, 232716],  # Throughput for key skewness 0.1
    [60821, 831831, 228193],  # Throughput for key skewness 0.25
    [90321, 903568, 231033],  # Throughput for key skewness 0.5
    [181259, 921569, 231611],  # Throughput for key skewness 0.75
    [3438904, 917747, 228548]   # Throughput for key skewness 1
])
...
ax.set_xlabel('Instance-Tuple Locality', fontsize=18, labelpad=12)
...
plt.savefig(os.path.join(figure_dir, '5.4.3_Locality_Throughput.pdf'))  # Save the figure
plt.savefig(os.path.join(figure_dir, '5.4.3_Locality_Throughput.png'))  # Save the figure
...
plt.savefig(os.path.join(local_figure_dir, '5.4.3_Locality_Throughput.pdf'))  # Save the figure