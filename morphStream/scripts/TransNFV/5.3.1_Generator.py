...
class PatternGenerator:
    def __init__(self, tuple_range=1000, instance_count=4, request_count=1000, pattern_1_prob=0.8, pattern_2_prob=0.7, pattern_3_prob=0.8):
        self.tuple_range = tuple_range
        self.instance_count = instance_count
        self.request_count = request_count
        self.base_dir = os.path.join(os.getcwd(), 'scripts/TransNFV/pattern_files/5.3.1')
...
if __name__ == "__main__":
    # Clear the base directory once before generating any files
    base_dir = os.path.join(os.getcwd(), 'scripts/TransNFV/pattern_files/5.3.1')
