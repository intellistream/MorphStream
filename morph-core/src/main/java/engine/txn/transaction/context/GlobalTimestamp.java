package engine.txn.transaction.context;

import java.util.concurrent.atomic.AtomicLong;

import static engine.txn.content.common.CommonMetaTypes.kBatchTsNum;
import static engine.txn.content.common.CommonMetaTypes.kMaxThreadNum;
