package engine.txn.scheduler.impl.og;


import engine.txn.durability.logging.LoggingEntry.LogRecord;
import engine.txn.durability.logging.LoggingStrategy.ImplLoggingManager.CommandLoggingManager;
import engine.txn.durability.logging.LoggingStrategy.ImplLoggingManager.DependencyLoggingManager;
import engine.txn.durability.logging.LoggingStrategy.ImplLoggingManager.LSNVectorLoggingManager;
import engine.txn.durability.logging.LoggingStrategy.ImplLoggingManager.PathLoggingManager;
...
import engine.txn.transaction.impl.ordered.MyList;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import engine.txn.profiler.MeasureTools;
import engine.txn.scheduler.Request;
import engine.txn.scheduler.impl.IScheduler;
...
import static engine.txn.content.common.CommonMetaTypes.AccessType.*;
import static util.FaultToleranceConstants.*;
import static util.FaultToleranceConstants.LOGOption_no;
