package engine.stream.execution.runtime;

import common.collections.Configuration;
import engine.stream.components.context.TopologyContext;
import engine.stream.components.operators.executor.BoltExecutor;
...
public class boltThread extends executorThread {
    ...
    public void run() {
        try {
            currentThread().setName("Operator:" + executor.getOP() + "\tExecutor ID:" + executor.getExecutorID());
            binding();
