...
public class MessageBatch {
    ...
    private int encoded_length;//Total size in bytes of all messages in this batch, MessageBlockLength(Int) * totalThreads + msg.length(Int) + msg + msg.length(Int) + msg
