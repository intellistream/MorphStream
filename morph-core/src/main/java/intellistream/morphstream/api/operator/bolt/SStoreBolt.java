...
public class SStoreBolt extends AbstractSStoreBolt {
    ...
    public SStoreBolt(String id, HashMap<String, FunctionDAGDescription> txnDescriptionHashMap, int fid) {
        super(id, LOG, fid);
    }
    public SStoreBolt(String id, HashMap<String, FunctionDAGDescription> txnDescriptionHashMap, int fid, AbstractSink sink) {
        super(id, LOG, fid);
        this.sink = sink;
        this.isCombo = true;
    }
