...
//            "java.lang.Byte[]"); // getObject return type
    ...
    private static final VoltType[] idx_lookup = new VoltType[VoltType.BOOLEAN.m_val + 1];
    private static final Map<String, VoltType> name_lookup = new HashMap<>();
    ...
    public Object getNullValue() {
        switch (this) {
            ...
            case DECIMAL:
                return NULL_DECIMAL;
            default:
                throw new VoltTypeException("No NULL value_list for " + this);
        }
    }
