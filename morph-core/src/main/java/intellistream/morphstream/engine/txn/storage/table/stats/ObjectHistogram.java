package intellistream.morphstream.engine.txn.storage.table.stats;
...
import intellistream.morphstream.engine.txn.storage.datatype.VoltType;
import intellistream.morphstream.engine.txn.storage.datatype.VoltTypeException;
...
//	}
    ...
    private long _put(X value, long count) {
        ...
        else if (count == 0 && !this.keep_zero_entries) {
