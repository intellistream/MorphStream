...
import intellistream.morphstream.engine.txn.durability.snapshot.SnapshotResult.SnapshotCommitInformation;
...
public class CheckpointManager extends FTManager {
    ...
    private final ConcurrentHashMap<Long, List<FaultToleranceStatus>> callSnapshot = new ConcurrentHashMap<>();
    ...
    private final ConcurrentHashMap<Long, SnapshotCommitInformation> registerSnapshot = new ConcurrentHashMap<>();
