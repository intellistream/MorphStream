...
public class Metrics {
    ...
    static class DSRuntime {
        ...
        public static long[] totalExecutionStartTime = new long[kMaxThreadNum];
        public static long[] totalExecutionEndTime = new long[kMaxThreadNum];
        public static DescriptiveStatistics[] totalExecutionTimeStatistics = new DescriptiveStatistics[kMaxThreadNum];
