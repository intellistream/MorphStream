...
void onPacketsGot(ConnId& tConnId, 
...
void onDatastoreReply(ConnId& aConnId, 
    ...
    */
    ...
    auto cConnId = aConnId \
        ...
        .registerCallback(READ, onPacketsGot) \
    ...
    registerCallback(aConnId, READ, onPacketsGot);
    registerCallback(aConnId, ERROR, onConnectionClose);
    // registerCallback(cConnId, READ, onPacketsGot);
...
void onNewConnectionEstablished(ConnId& aConnId, 
...
int SL(int argc, char *argv[]) {
    ...
    */
    ...
    registerCallback(serverId, ACCEPT, onNewConnectionEstablished);
    // LB: just transfer to C.
    registerCallback(serverId, READ, onPacketsGot);
    // LB: just transfer to C.
