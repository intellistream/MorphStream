 ...
 */
public class OGBFSScheduler extends AbstractOGBFSScheduler<OGBFSContext> {
    ...
    @Override
    public void EXPLORE(OGBFSContext context) {
    ...
    @Override
    protected void NOTIFY(BFSOperationChain operationChain, OGBFSContext context) {
    }

    @Override
    public void TxnSubmitFinished(OGBFSContext context) {
    ...
    private void constructOp(List<BFSOperation> operationGraph, Request request) {
        ...
        OGBFSContext targetContext = getTargetContext(request.src_key);
...
//     */
//    @Override
//    public boolean executeWithBusyWait(OGBFSContext context, BFSOperationChain operationChain, long mark_ID) {
