...
public class Request {
    ...
    public Request(TxnContext txn_context,
                   ...
                   long value) {
        this(txn_context, accessType, operator_name, table_name, src_key, null, d_record, null, null);
        this.value = value;
    }
    ...
    public Request(TxnContext txn_context,
                   ...
                   TableRecord d_record,
                   Function function) {
        this(txn_context, accessType, operator_name, table_name, src_key, s_record, d_record, function, null);
    }
    ...
    public Request(TxnContext txn_context,
                   ...
                   Condition condition,
                   int[] success) {
        this(txn_context, accessType, operator_name, table_name, src_key, s_record, d_record, function, record_ref, null, null, null, condition, success);
    }
