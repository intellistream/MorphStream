...
public class BFSOperation extends AbstractOperation {
    ...
    public <Context extends OCSchedulerContext> BFSOperation(String pKey, Context context, String table_name, TxnContext txn_context, long bid,
    ...
    public <Context extends OCSchedulerContext> BFSOperation(
