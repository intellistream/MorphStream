...
if(NOT EXISTS "/Users/shuhaozhang/Sesame/cpp-lib/join/cmake-build-release/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: /Users/shuhaozhang/Sesame/cpp-lib/join/cmake-build-release/install_manifest.txt")
endif()

# remove files from 'install_manifest.txt'
message(STATUS "")
message(STATUS "Removing files from 'install_manifest.txt'")
file(READ "/Users/shuhaozhang/Sesame/cpp-lib/join/cmake-build-release/install_manifest.txt" files)
