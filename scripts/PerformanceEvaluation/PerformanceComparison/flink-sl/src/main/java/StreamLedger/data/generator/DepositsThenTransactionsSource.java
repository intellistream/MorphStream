 ...
 * canceled.
 */
public class DepositsThenTransactionsSource extends RichParallelSourceFunction<Either<DepositEvent, TransactionEvent>> {
    ...
    public DepositsThenTransactionsSource(int maxRecordsPerSecond) {
