...
function runTStream() {
  echo "java -Xms300g -Xmx300g -jar -d64 /home/myc/workspace/MorphStream/application/target/application-0.0.2-jar-with-dependencies.jar \
          --app $app \
          --NUM_ITEMS $NUM_ITEMS \
          --tthread $tthread \
          --scheduler $scheduler \
  ...
  java -Xms300g -Xmx300g -Xss100M -XX:+PrintGCDetails -Xmn100g -XX:+UseG1GC -jar -d64 /home/myc/workspace/MorphStream/application/target/application-0.0.2-jar-with-dependencies.jar \
    --app $app \
    --NUM_ITEMS $NUM_ITEMS \
    --tthread $tthread \
    --scheduler $scheduler \
