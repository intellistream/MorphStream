...
if __name__ == "__main__":
    ...
    variants = [10,30,50,70,90]
    throughput_results_1 = []
    for variant in variants:
        target_dir = generate_address(app, "OP_NS_A", threads, total_events, num_items, variant,
    ...
    for variant in variants:
        target_dir = generate_address(app, "OG_NS_A", threads, total_events, num_items, variant,
                                      state_access_skewness,
                                      ratio_of_overlapped_keys, ratio_of_transaction_aborts, transaction_length,
                                      is_cyclic, complexity)
        full_path = os.path.join(data_path, target_dir)
...
plot_comparison_bar_chart(x_values, throughput_results_1, throughput_results_2, labels, "Ratio of Multiple State Access (%)", "Throughput (k/sec)", "Figure16_c")
