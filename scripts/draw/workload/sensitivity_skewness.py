...
def ReadFileGS(x_axis, tthread, batchInterval, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity):
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     gs_path = getPath("GSA", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     bfs_path = getPath("BFSA", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     dfs_path = getPath("DFSA", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     op_gs_path = getPath("OPGSA", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    #     lines = open(op_gs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     op_bfs_path = getPath("OPBFSA", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     op_dfs_path = getPath("OPDFSA", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    #     lines = open(op_dfs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     op_dfs_path = getPath("PAT", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    #     lines = open(op_dfs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
...
def ReadFileSL(x_axis, tthread, batchInterval, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity):
    ...
    # for key_skewness in x_axis:
    #     inputEvents = tthread * batchInterval
    #     op_gs_path = getPathSL("GSA", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity)
    #     lines = open(op_gs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
    #     y[1].append(float(throughput))
    ...
    for key_skewness in x_axis:
        inputEvents = tthread * batchInterval
        op_dfs_path = getPathSL("TStream", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity)
        lines = open(op_dfs_path).readlines()
        throughput = lines[0].split(": ")[1]
        y[1].append(float(throughput))
    ...
    for key_skewness in x_axis:
        inputEvents = tthread * batchInterval
        op_dfs_path = getPathSL("PAT", inputEvents, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity)
        lines = open(op_dfs_path).readlines()
        throughput = lines[0].split(": ")[1]
        y[2].append(float(throughput))
