...
FIGURE_FOLDER = './results/model/granularity/batch'
...
if __name__ == '__main__':
    ...
    y_values = ReadFileGS(x_axis, tthread, batchInterval, NUM_ITEMS, Ratio_of_Multiple_State_Access, key_skewness, overlap_ratio,
