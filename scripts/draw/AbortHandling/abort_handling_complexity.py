...
if __name__ == "__main__":
    ...
    ratio_of_transaction_aborts = 5000
    transaction_length = 1
    is_cyclic = "true"
    complexity = 0

    variants = [0, 20000, 40000, 60000, 80000, 100000]
    ...
    x_values = [0, 20, 40, 60, 80, 100]  # x 轴值

# 示例数据
labels = ["e-abort", "l-abort"]  # 图例标签

plot_comparison_bar_chart(x_values, throughput_results_1, throughput_results_2, labels, "Complexity (us)", "Throughput (k/sec)", "Figure17_a")
