...
def ReadFileGS(x_axis, tthread, batchInterval, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity):
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     gs_path = getPath("GSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     bfs_path = getPath("BFSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     dfs_path = getPath("DFSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     op_gs_path = getPath("OPGSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    #     lines = open(op_gs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     op_bfs_path = getPath("OPBFSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     op_dfs_path = getPath("OPDFSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    #     lines = open(op_dfs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     op_dfs_path = getPath("PAT", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio)
    #     lines = open(op_dfs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
...
def ReadFileSL(x_axis, tthread, batchInterval, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity):
    ...
    for key_skewness in x_axis:
        events = tthread * batchInterval
        op_gs_path = getPathSL("OPGSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity)
        lines = open(op_gs_path).readlines()
        throughput = lines[0].split(": ")[1]
        y[0].append(float(throughput))
    ...
    # for key_skewness in x_axis:
    #     events = tthread * batchInterval
    #     op_gs_path = getPathSL("GSA", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity)
    #     lines = open(op_gs_path).readlines()
    #     throughput = lines[0].split(": ")[1]
    #     y[1].append(float(throughput))
    ...
    for key_skewness in x_axis:
        events = tthread * batchInterval
        op_dfs_path = getPathSL("TStream", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity)
        lines = open(op_dfs_path).readlines()
        throughput = lines[0].split(": ")[1]
        y[1].append(float(throughput))
    ...
    for key_skewness in x_axis:
        events = tthread * batchInterval
        op_dfs_path = getPathSL("PAT", events, tthread, NUM_ITEMS, NUM_ACCESS, key_skewness, overlap_ratio, abort_ratio, isCyclic, complexity)
        lines = open(op_dfs_path).readlines()
        throughput = lines[0].split(": ")[1]
        y[2].append(float(throughput))
...
if __name__ == '__main__':
    ...
    DrawFigure(x_axis, y_axis, legend_labels, "zipf_skew", "throughput(e/s)", "sl_skewness_throughput_t{}_b{}_{}_{}_{}_{}_{}_{}_{}"
    ...
    DrawFigure(x_axis, y_axis, legend_labels, "zipf_skew", "throughput(e/s)", "gs_skewness_throughput_t{}_b{}_{}_{}_{}_{}_{}_{}_{}"
