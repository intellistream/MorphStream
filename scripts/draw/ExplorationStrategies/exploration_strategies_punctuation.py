...
if __name__ == "__main__":
    ...
    for variant in variants:
        target_dir = generate_address(app, "OP_NS", threads, variant, num_items, ratio_of_deposit,
    ...
    for variant in variants:
        target_dir = generate_address(app, "OP_BFS", threads, variant, num_items, ratio_of_deposit,
                                      state_access_skewness,
                                      ratio_of_overlapped_keys, ratio_of_transaction_aborts, transaction_length,
                                      is_cyclic, complexity)
        full_path = os.path.join(data_path, target_dir)
    ...
    for variant in variants:
        target_dir = generate_address(app, "OP_DFS", threads, variant, num_items, ratio_of_deposit,
                                      state_access_skewness,
                                      ratio_of_overlapped_keys, ratio_of_transaction_aborts, transaction_length,
                                      is_cyclic, complexity)
        full_path = os.path.join(data_path, target_dir)
...
plot_comparison_bar_chart(x_values, throughput_results_1, throughput_results_2, throughput_results_3, labels, "Punctuation Interval", "Throughput (k/sec)", "Figure15_a")
